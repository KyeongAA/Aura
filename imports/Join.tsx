function Div() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-center leading-[1.2] not-italic relative shrink-0 text-[#181819]" data-name="div">
      <p className="font-['Pretendard:SemiBold',sans-serif] min-w-full relative shrink-0 text-[36px] text-center w-[min-content]">회원가입</p>
      <p className="font-['Pretendard:Regular',sans-serif] relative shrink-0 text-[13px] text-nowrap whitespace-pre">새 계정을 만들어 서울의 Aura를 기록하세요</p>
    </div>
  );
}
...
function Label2() {
  return (
    <div className="box-border content-stretch flex gap-[10px] items-center justify-center px-[24px] py-0 relative shrink-0" data-name="Label">
      <p className="font-['Pretendard:Regular',sans-serif] leading-[1.2] not-italic relative shrink-0 text-[#181819] text-[13px] text-nowrap whitespace-pre">비밀번호 확인</p>
    </div>
  );
}
...
function Input2() {
  return (
    <div className="bg-[#fffce0] relative rounded-[999px] shrink-0 w-full" data-name="input">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] items-center px-[28px] py-[20px] relative w-full">
          <p className="basis-0 font-['Pretendard:Regular',sans-serif] grow leading-[1.2] min-h-px min-w-px not-italic relative shrink-0 text-[#abacaf] text-[20px]">비밀번호를 다시 입력하세요</p>
        </div>
      </div>
    </div>
  );
...
function InputPasswordCheck() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Input_password_check">
      <Label2 />
      <Input2 />
    </div>
  );
...
function Label3() {
  return (
    <div className="box-border content-stretch flex gap-[10px] items-center justify-center px-[24px] py-0 relative shrink-0" data-name="Label">
      <p className="font-['Pretendard:Regular',sans-serif] leading-[1.2] not-italic relative shrink-0 text-[#181819] text-[13px] text-nowrap whitespace-pre">이름(닉네임)</p>
    </div>
  );
}
...
function Input3() {
  return (
    <div className="bg-[#fffce0] relative rounded-[999px] shrink-0 w-full" data-name="input">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] items-center px-[28px] py-[20px] relative w-full">
          <p className="basis-0 font-['Pretendard:Regular',sans-serif] grow leading-[1.2] min-h-px min-w-px not-italic relative shrink-0 text-[#abacaf] text-[20px]">닉네임을 입력하세요</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="bg-[#f46964] relative rounded-[999px] shrink-0 w-full" data-name="btn_cta">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[10px] items-center justify-center px-[20px] py-[16px] relative w-full">
          <p className="font-['Pretendard:SemiBold',sans-serif] leading-[1.2] not-italic relative shrink-0 text-[24px] text-nowrap text-white whitespace-pre">회원가입</p>
        </div>
      </div>
    </div>
  );
...
function Div2() {
  return (
    <div className="content-stretch flex flex-col font-['Pretendard:Regular',sans-serif] gap-[12px] items-center leading-[1.2] not-italic relative shrink-0 text-[13px] text-center" data-name="div">
      <p className="relative shrink-0 text-[#181819] text-[0px] text-nowrap whitespace-pre">
        <span>{`이미 계정이 있으신가요? `}</span>
        <span className="text-[#f24e4e]">로그인</span>
      </p>
      <p className="min-w-full relative shrink-0 text-[#939496] w-[min-content]">← 홈으로 돌아가기</p>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[40px] items-center left-[calc(25%+53px)] top-[170px]">
      <Div />
      <Div1 />
      <Div2 />
    </div>
...
function Home() {
  return (
    <div className="box-border content-stretch flex gap-[10px] items-center justify-center p-[10px] relative shrink-0 size-[90px]" data-name="home">
      <p className="font-['Pretendard:SemiBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#313132] text-[24px] text-nowrap whitespace-pre">Home</p>
    </div>
  );
}
...
export default function Join() {
  return (
    <div className="bg-[#fcfcfc] relative size-full" data-name="join">
      <Frame />
      <Gnb />
    </div>
  );
